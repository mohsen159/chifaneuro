    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form autocomplete="off" action="actions/insert_sale.php" method="post" class="was-validated"
                    id="form_sales" name="form_sales">
                    <div class="mb-3 mt-3 autocomplete">
                        <input type="hidden" name="clientid">
                        <input type="text" onfocus="find_client(this)" onblur="find_clientid(this)" class="form-control"
                            id="input_client" placeholder="client" name="client" required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                    <br>
                    <select id="select" class="form-select form-select-sm" aria-label="Default select example"
                        name="employs">
                        <!--fetch user -->
                        <?php
                    ...
                    <div id="1" class="mt-3 autocomplete d-flex flex-nowrap justify-content-between space">
                        ...
                        <input type="text" onfocus="find_product(this)" onblur="find_productid(this)"
                            class="form-control order-1 p-2" placeholder="Name" name="name[]" required>
                        <input type="text" class="order-2 p-2" style="width:80px" placeholder="Lot" name="lot[]"
                            required>
                        <input type="number" class="order-3 p-2" style="width:100px" placeholder="Amount"
                    ...
                    <div class="mb-3 mt-3">
                        <input type="text" class="form-control" id="num_order" placeholder="num_order" name="num_order"
                            required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
...
<div class="modal fade bd-example-modal-sm" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form autocomplete="off" action="/operation/update_sale.php" method="post" class="was-validated"
                    id="sale_update" name="sale_update">
                    <div class="mb-3 mt-3">
                        <input type="hidden" class="form-control" id="id" name="id" required>
                        <!-- this on soo we can know wich sales id -->
                    </div>
                    <div class="mb-3 mt-3">
                        <textarea class="form-control" id="medication" placeholder="medication" name="medication"
                            required>
                               </textarea>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    ...
                    <br>
                    <div class="mb-3 mt-3">
                        <input type="text" min="1" max="100" class="form-control" id="dure" placeholder="dure"
                            name="dure" required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-outline-danger"
                        onclick='delet( document.forms["sale_update"]["id"].value ,"sales")'
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="was-validated" id="new_client">
                    ...
                    <div class="mb-3 mt-3">
                        <input type="text" class="form-control" id="fname" placeholder="Enter family name" name="fname"
                            required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
