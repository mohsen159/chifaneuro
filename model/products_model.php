...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true" id="addproductlist">
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form autocomplete="off" action="actions/add_products.php" method="post" class="was-validated"
                    id="new_product" name="new_product">
                    <div id="1" class="mt-3 autocomplete d-flex flex-nowrap justify-content-between space">
